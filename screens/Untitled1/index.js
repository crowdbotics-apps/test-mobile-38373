...
const Untitled1 = ({
  ...
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }}><ImageBackground style={styles.LsmCTxHW} source={{
      ...
      }} resizeMode="cover"></ImageBackground><CheckBox style={styles.OsNCproK} title="Checkbox Title"></CheckBox><TextInput style={styles.zkTLLLEd}></TextInput><Pressable onPress={() => navigation.navigation.navigate("Untitled2", {})}><View style={styles.BvOWwjTr}></View></Pressable></ScrollView>
    </SafeAreaView>;
};
